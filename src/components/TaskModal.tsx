							...
							<div className="modal-column">
								...
								<div className="modal-row">
									...
									<div className="assignee-picker-wrapper">
										<div className="assignee-avatar-row">
											{(() => {
												const selected = AvaStackedData.filter((a) => form.assigneeIds.includes(a.id));
												const MAX_VISIBLE = 4;
												...
												return (
													<>
														{visible.map((a) => (
															<img key={a.id} src={a.avaimg} alt={`User ${a.id}`} className="assignee-stacked-avatar" />
														))}
														{overflow > 0 && (
															<span className="assignee-overflow-badge">+{overflow}</span>
														)}
													</>
												);
											})()}
